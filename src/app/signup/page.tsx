        ...
        <div className="w-full p-8">
          ...
          <div className="w-full flex gap-2">
            <div className="w-full">
              ...
              <input type="email" placeholder="Enter User Email" className="w-full p-2.5 border rounded-md mt-1" />
            </div>
            <div className="w-full">
              <label className="block text-lg font-[500] ">Password</label>
              <input type="password" placeholder="Enter Password" className="w-full p-2.5 border rounded-md mt-1" />

            </div>
          </div>

          {/* Login Button */}
          <button className="mt-2 bg-[#40282C] w-full hover:bg-[#5d313a] text-white font-bold py-2 px-4 rounded">Sign UP</button>

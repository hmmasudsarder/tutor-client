        ...
        <div>
            <div className="lg:flex h-screen">
                ...
                <div className="w-1/2 flex justify-center items-center bg-white">
                    <div className="w-full p-8">
                        ...
                        <div className="flex flex-col flex-wrap items-center justify-center">
                            ...
                            <h2 className="text-2xl font-semibold mt-2 mb-5">Sign UP</h2>
                        </div>


                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="mb-3 w-full">
                                <label className={`text-base font-[500] w-full`}>User Role</label>
                                <select
                                {...register("role", { required: true })} 
                                    className={`w-full mt-2 px-2 py-2 rounded-lg border-2 border-borderColor focus:border-borderColor focus:ring-darkOrange outline-none `}
                                >
              ...
              <p className="text-red-500 ">{errors.role.message}</p>
                            ...
                            <div className="mb-3 w-full">
                                <label className={`text-base font-[500] w-full`}>Name</label>
                                <input
                            ...
                            <div className="w-full flex gap-2">
                                <div className="w-full">
                                    ...
                                    <input
                                        ...
                                        type="email" placeholder="Enter User Email" className="w-full p-2.5 border rounded-md mt-1" />
                                </div>
                                <div className="w-full">
                                    <label className="block text-lg font-[500] ">Password</label>
                                    <input
                                        {...register("password", { required: true })}
                                        type="password" placeholder="Enter Password" className="w-full p-2.5 border rounded-md mt-1" />

                                </div>
                            </div>


                            <button type='submit' className="mt-2 bg-[#40282C] w-full hover:bg-[#5d313a] text-white font-bold py-2 px-4 rounded">Sign UP</button>
                        </form>


                        {/* Forgot Password Link */}
                        <div className="text-center mt-4">
                            <Link href="/login" className="text-lg ">If have an account. <span className="underline text-blue-400">  Sign In here ?</span> </Link>
                        </div>
                    </div>
                </div>
            </div>
